...
@property (nonatomic, strong) UIImageView *orderImageView;///<图片
@property (nonatomic, strong) UILabel *englishNameLabel;///<英文名称
@property (nonatomic, strong) UILabel *nameLabel;///<中文名称
@property (nonatomic, strong) UILabel *describeLabel;///<描述
@property (nonatomic, strong) UILabel *selledCountLabel;///<数量
@property (nonatomic, strong) UILabel *calorieLabel;///<卡路里
@property (nonatomic, strong) UILabel *priceLabel;///<价格
@property (nonatomic, strong) UILabel *residueStockLabel;///<库存
@property (nonatomic, strong) UITextField *residueStockTextField;///<库存
@property (nonatomic, strong) UIButton *parameterSettingButton;///<参数设置
...
- (void)setOrder:(YMSelledSeetingOrder *)order{
    _order = order;
    self.orderImageView.image = [UIImage imageNamed:@"suancaiyu"];
}
- (void)setCellStyle:(YMSelledSettingCellStyle)cellStyle{
    _cellStyle = cellStyle;
    if (cellStyle == YMSelledSettingCellStyleNormal) {
        [self.parameterSettingButton removeFromSuperview];
    }
}
- (void)awakeFromNib {
    [super awakeFromNib];
