...
//    [alert show];
    [CXShareAlertView showViewWithMessage:message];
}
...
void TTAlertExt(NSString *message, void(^callback)(void)) {
    CXShareAlertView *alertView = [CXShareAlertView showViewWithMessage:message];
    alertView.didConfirmCallback = ^{
        callback();
    };
}
