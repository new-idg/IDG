...
- (void)viewDidLoad {
    ...
    [self.navigationController.navigationBar setBackgroundImage:[self imageWithColor:[MyPublicClass colorWithHexString:@"#F83030"]] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([title isEqualToString:@"设置"]) {
        pushViewController = [[InstallViewController alloc] init];
